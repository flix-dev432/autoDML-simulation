...
# Train theta model
def train_theta(theta_model, a, x, y, lambda_theta=0.001, epochs=100, batch_size=64, lr=0.01):
            ...
            for batch_local_idx, batch_a, batch_x in train_dataloader:
                ...
                for local_idx, a, x in zip(batch_local_idx, batch_a, batch_x):
                    ...
                    with torch.no_grad():
                        ...
                        theta_ax = theta_model(a.unsqueeze(0), x.unsqueeze(0)).squeeze()
                    ...
                    alpha_ax = alpha_model(a_tensor, x_tensor).squeeze()
                    
                    # Alpha differences (alpha(1,X) - alpha(0,X))
                    alpha_1x = alpha_model.g1(x_tensor).squeeze()
                    alpha_0x = alpha_model.g0(x_tensor).squeeze()
